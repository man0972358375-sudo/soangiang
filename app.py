...
<div class="main-header">
    ...
    <p>Tác giả: Nguyễn Thị Mận - Trường Tiểu học Hồng Lạc - ĐT: 097 2358 375</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Nguyễn Thị Mận - Trường Tiểu học Hồng Lạc - ĐT: 097 2358 375</div>", unsafe_allow_html=True)